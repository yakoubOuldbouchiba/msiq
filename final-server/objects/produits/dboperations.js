      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            pool = _context.sent;
            _context.next = 6;
            return pool.request().query("GETPRODUITS");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            pool = _context2.sent;
            _context2.next = 7;
            return pool.request().input('cp', sql.VarChar, produit.code_produit).input('desig', sql.VarChar, produit.designation).input('qty', sql.Int, parseInt(produit.quantite)).execute("SETPRODUIT");
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            pool = _context4.sent;
            _context4.next = 6;
            return pool.request().input("code_produit", sql.VarChar, code_objet).execute("DELETEPRODUIT");
