    ...
    <v-dialog max-width="600" persistent v-model="dialog">
        <v-card>
            ...
            <v-card-text>
                <v-container v-if="name=='Vehicule'">
                    <v-row>
                      <v-col cols="12"  sm="6" md="4" >
                        <v-text-field v-model="item.name" label="Nom"></v-text-field>
                      </v-col>
                    <v-col cols="12"  sm="6" md="4" >
                ...
                <v-row>
                      <v-col cols="12"  sm="6" md="4" >
                        <v-text-field v-model="item.idChauffeur" label="ID"></v-text-field>
                      </v-col>
                    <v-col cols="12"  sm="6" md="4" >
                    ...
                    <v-col cols="12"  sm="6" md="4" >
                        <v-text-field v-model="item.permis" label="Premis"></v-text-field>
                      </v-col>
                    </v-row>
                </v-container>
            </v-card-text>
